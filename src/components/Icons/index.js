...
export function UserIcon({ className, size = '1em' }) {
    return (
        <svg
            className={className}
            width={size}
...
export function TikTokCoinIcon({ className, size = '1em' }) {
    return (
        <svg
            className={className}
            width={size}
...
export function GearIcon({ className, size = '1em' }) {
    return (
        <svg
            className={className}
            width={size}
...
export function LanguageIcon({ className, size = '1em' }) {
    return (
        <svg
            className={className}
            width={size}
...
export function QuestionIcon({ className, size = '1em' }) {
    return (
        <svg
            className={className}
            width={size}
...
export function KeyboardIcon({ className, size = '1em' }) {
    return (
        <svg
            className={className}
            width={size}
...
export function MoonIcon({ className, size = '1em' }) {
    return (
        <svg
            className={className}
            width={size}
